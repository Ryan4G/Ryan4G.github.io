...
class GameScene extends Phaser.Scene
{
    ...
    create(){
        ...
        this.changeColor = this.add.sprite(width - 30, height - 200, 'ball').setScale(2).setInteractive();
        ...
        this.nextColor = this.add.sprite(width - 30, height - 150, 'ball').setScale(1.2);
        this.nextColor.alpha = 0.6;
        this.nextColor.setFrame(1);
        
        var nextRect = new Phaser.Geom.Rectangle();
        var nexrRectWidth = this.nextColor.width + 8;
